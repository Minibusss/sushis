...
def fonction1():
    ...
    recette = input('choisissez une recette que vous souhaitez manger: ')
    if recette=='1':
    ...
    if recette=='2':
        ...
        print(ma.cuisson_riz)
        print(ma.tips1)
        print(ma.recette_maki_crevette)
        print(ma.tips2)
    ...
    if recette=='4':
        ...
        print(ma.cuisson_riz)
        print(ma.tips1)
        print(ma.recette_maki_ommelette)
        print(ma.tips2)
